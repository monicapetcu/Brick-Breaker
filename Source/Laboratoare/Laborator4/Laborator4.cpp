...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	modelMatrix = glm::mat4(1);
	modelMatrix *= Transform3D::Translate(10.0f, 0.5f, -1.5f);
	modelMatrix *= Transform3D::Translate(translateXmoon, translateYmoon, translateZmoon);
	angularStepOYmoon += deltaTimeSeconds;
	modelMatrix *= Transform3D::RotateOY(angularStepOYmoon);
	RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
	...
	modelMatrix *= Transform3D::Translate(7.5f, 0.5f, -1.5f);
	modelMatrix *= Transform3D::Translate(translateXterra, translateYterra, translateZterra);
	angularStepOYterra += deltaTimeSeconds;
	modelMatrix *= Transform3D::RotateOY(angularStepOYterra * 5);
	RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
	modelMatrix2 = modelMatrix;

	modelMatrix = glm::mat4(1);
	modelMatrix *= modelMatrix2;
	modelMatrix *= Transform3D::Translate(2.0f, 0.5f, -1.5f);
	modelMatrix *= Transform3D::Translate(translateXsun, translateYsun, translateZsun);
	modelMatrix *= Transform3D::Scale(0.3f, 0.3f, 0.3f);
	angularStepOYsun += deltaTimeSeconds;
