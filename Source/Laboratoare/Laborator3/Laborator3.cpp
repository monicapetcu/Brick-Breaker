...
void Laborator3::Init()
{
	...
	//Mesh* square4 = Object2D::CreateSquare("square3", corner, squareSide, glm::vec3(0, 0, 1));
...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	if (translateX >= (window->GetResolution()).x || translateY >= (window->GetResolution()).y) {
		intoarcere = 1;
	}
	...
	scaleX -= deltaTimeSeconds * 0.25;
	scaleY -= deltaTimeSeconds * 0.25;
